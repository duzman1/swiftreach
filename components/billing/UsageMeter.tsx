...
//
// The "Resets" date is always the 1st of the next calendar month at
// 00:00 UTC — plan-independent — and matches the billing page by
// construction.
...
import { firstOfNextMonthUtc, formatResetDate } from "@/lib/usagePeriod";
...
export function UsageMeter({ plan, used }: Props) {
